...
-- ============================================
-- PASO 12: TABLAS DE PROGRESO ADICIONALES (Inducción y Legacy)
-- ============================================

-- Tabla para el nuevo sistema de inducción 2026 (Architecture C)
...
CREATE POLICY "Permitir gestión de progreso propio" ON public.user_module_progress FOR ALL USING (true);

-- Tabla para sistemas heredados (Architecture B)
CREATE TABLE IF NOT EXISTS public.progreso_modulos (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    usuario TEXT NOT NULL, -- cédula o email
...
CREATE POLICY "Permitir gestión de progreso legacy" ON public.progreso_modulos FOR ALL USING (true);

-- ============================================
-- ¡LISTO! El esquema completo está creado
-- ============================================
